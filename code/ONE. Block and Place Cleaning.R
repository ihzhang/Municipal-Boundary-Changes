...
acs13 %<>%
    ...
    select(plid, Geo_NAME, vap13p:pctothervap13p)
...
pl1014 <- 
  left_join(
    places2010 %>% select(
      c(plid, Geo_NAME, pop10p:pctothervap10p)), 
    places2014 %>% select(
...
pl1417 <- 
  left_join(
    places2014 %>% select(
      c(plid, Geo_NAME, pop14p:pctothervap14p)), 
    places2017 %>% select(-Geo_NAME), 
    by = "plid")
...
pl1720 <- 
  left_join(
    places2017 %>% select(
      c(plid, Geo_NAME, hu17p:pop17p)), 
    places2020 %>% select(-Geo_NAME), 
    by = "plid")
