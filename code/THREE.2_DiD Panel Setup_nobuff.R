...
table(pl_annex_var_1420$plid %in% pl0007$plid) #125 false
...
names(pl_annex_var_1420) <- gsub("07p", "_p0", names(pl_annex_var_1420))
names(pl_annex_var_1420)
...
names(pl_annex_var_1420)
names(pl_annex_var_1420) <- gsub("13p", "_p1", names(pl_annex_var_1420))
...
rm(aa1420, pl_annex_var_1420, pl0007, places2013, cdps07)
